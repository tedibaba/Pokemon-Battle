...
class TwoWayArraySortedList(ArraySortedList[T]):
    """
    A sorted list that is able to maintain a both ascending and descending sorted list. It can only do one a time though.
    """
